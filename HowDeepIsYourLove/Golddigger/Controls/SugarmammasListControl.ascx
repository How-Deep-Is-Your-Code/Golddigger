<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SugarmammasListControl.ascx.cs" Inherits="Golddigger.Controls.SugarmammasListControl" %>
<div class="jumbotron">
    <h1 class="text-center">Sugarmammas</h1>
</div>
<div class="row">
    <div class="table-responsive">
        <table class="table">
            ...
            <asp:ListView runat="server" ID="ListViewAllSugarmammas" ItemType="Golddigger.Models.User" SelectMethod="ListView_GetSugarmammas">
                <ItemTemplate>
    ...
    <div class="text-center">
        <asp:DataPager class="btn-group btn-group-sm" ID="allGDPager" runat="server" PagedControlID="ListViewAllSugarmammas" PageSize="5">
            <Fields>
