<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SugardaddiesListControl.ascx.cs" Inherits="Golddigger.Controls.SugardaddiesListControl" %>
<div class="jumbotron"><h1 class="text-center">Sugardaddies</h1></div>
<div class="row">
    <div class="table-responsive">
        <table class="table">
            ...
            <asp:ListView runat="server" ID="ListViewAllSugardaddies" ItemType="Golddigger.Models.User" SelectMethod="ListView_GetSugardaddies">
                <ItemTemplate>
    ...
    <div class="text-center">
        <asp:DataPager class="btn-group btn-group-sm" ID="allGDPager" runat="server" PagedControlID="ListViewAllSugardaddies" PageSize="5">
            <Fields>
