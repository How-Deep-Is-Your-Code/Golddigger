[assembly: WebActivatorEx.PreApplicationStartMethod(typeof(Golddigger.App_Start.NinjectWebCommon), "Start")]
[assembly: WebActivatorEx.ApplicationShutdownMethodAttribute(typeof(Golddigger.App_Start.NinjectWebCommon), "Stop")]
...
namespace Golddigger.App_Start
{
    ...
    public static class NinjectWebCommon 
    {
        ...
        private static void RegisterServices(IKernel kernel)
        {
            ...
            kernel.Bind<ITownsService>().To<TownsService>().InRequestScope();
