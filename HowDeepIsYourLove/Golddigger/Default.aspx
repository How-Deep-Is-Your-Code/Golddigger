    ...
    <div class="jumbotron">
            ...
            <asp:ListView runat="server" ID="ListViewGoldDiggerImages" ItemType="Golddigger.Models.User" SelectMethod="ListViewImages_GetGolddiggers">
                ...
                <ItemTemplate>
                    <div class="row">
                        ...
                        <h4>
                            <asp:HyperLink NavigateUrl='<%# "~/Account/Profile.aspx?id=" + Item.Id %>' runat="server" Text="<%#: Item.UserName %>" /></h4>
                    </div>
                </ItemTemplate>
            </asp:ListView>
        </div>
        ...
        <div class="col-md-4">
            <asp:ListView runat="server" ID="ListViewSugarmammasImages" ItemType="Golddigger.Models.User" SelectMethod="ListViewImages_GetSugarmammas">
                ...
                <ItemTemplate>
                    <div class="row">
                        <img src='<%# "data:image/jpeg;base64,"+ Convert.ToBase64String(Item.ProfilePhoto)%>' alt="Profile Photo" width="10%" height="10%">
                        <h4>
                            <asp:HyperLink NavigateUrl='<%# "~/Account/Profile.aspx?id=" + Item.Id %>' runat="server" Text="<%#: Item.UserName %>" /></h4>
                    </div>
                </ItemTemplate>
